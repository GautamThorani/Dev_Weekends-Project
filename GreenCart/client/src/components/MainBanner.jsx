...
const MainBanner = () => {
  return (
    <div className='relative'>
      ...
      <img src={assets.main_banner_bg_sm} alt="sm-banner" className='w-full md:hidden' />
      ...
      <div className='flex items-center mt-6 font-medium'>
        <Link to = {"/products"} className="group flex items-center gap-2 px-7 md:px-9 py-3 bg-primary hover:bg-primary-dull transition rounded
