        ...
        <div className="flex flex-col md:flex-row mt-16">
            <div className='flex-1 max-w-4xl'>
                ...
                {cartArray.map((product, index) => (
                    <div key={index} className="grid grid-cols-[2fr_1fr_1fr] text-gray-500 items-center text-sm md:text-base font-medium pt-3">
                            ...
                            <div>
                                ...
                                <div className="font-normal text-gray-500/70">
                                    ...
                                    <div className='flex items-center'>
                                        <p>Qty:</p>
                                        <select onChange={e => updateCartItems(product._id, _Number(e.target.value))} value={cartItems[product._id]} className='outline-none'>
                        ...
                        <button className="cursor-pointer mx-auto">
                            <img onClick={()=> removeFromCart(product._id)} src={assets.remove_icon} alt="remove"
                ...
                <button className="group cursor-pointer flex items-center mt-8 gap-2 text-primary font-medium">
                    <img onClick={()=>{navigate("/products"); scrollTo(0,0)}} className='group-hover:-translate-x-1 transition' src={assets.arrow_right_icon_colored} alt="arrow" />
                    Continue Shopping
                </button>
